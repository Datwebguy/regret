...
type DashboardTab = "overview" | "structures" | "regime" | "probe" | "stream";
  ...
  return (
    <div className="stack">
      <PageHead
        ...
        title="Autonomous AI Options Trading Desk"
        lead="Defined-risk options spread engine pairing open-source LLMs with 6 deterministic mathematical risk gates."
      />

      {/* Live Desk Sub-Navigation Tabs */}
      <div style={{
        display: "flex",
        gap: 8,
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            borderRadius: 3,
            border: activeTab === "overview" ? "1px solid var(--ink)" : "1px solid transparent",
            background: activeTab === "overview" ? "var(--ink)" : "transparent",
            color: activeTab === "overview" ? "var(--sheet)" : "var(--soft)",
            cursor: "pointer",
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            borderRadius: 3,
            border: activeTab === "structures" ? "1px solid var(--ink)" : "1px solid transparent",
            background: activeTab === "structures" ? "var(--ink)" : "transparent",
            color: activeTab === "structures" ? "var(--sheet)" : "var(--soft)",
            cursor: "pointer",
            transition: "all 0.15s ease",
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            borderRadius: 3,
            border: activeTab === "regime" ? "1px solid var(--ink)" : "1px solid transparent",
            background: activeTab === "regime" ? "var(--ink)" : "transparent",
            color: activeTab === "regime" ? "var(--sheet)" : "var(--soft)",
            cursor: "pointer",
            transition: "all 0.15s ease",
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            borderRadius: 3,
            border: activeTab === "probe" ? "1px solid var(--ink)" : "1px solid transparent",
            background: activeTab === "probe" ? "var(--ink)" : "transparent",
            color: activeTab === "probe" ? "var(--sheet)" : "var(--soft)",
            cursor: "pointer",
            transition: "all 0.15s ease",
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            borderRadius: 3,
            border: activeTab === "stream" ? "1px solid var(--ink)" : "1px solid transparent",
            background: activeTab === "stream" ? "var(--ink)" : "transparent",
            color: activeTab === "stream" ? "var(--sheet)" : "var(--soft)",
            cursor: "pointer",
            transition: "all 0.15s ease",
          }}
        >
          📜 Decision Stream &amp; Refusals
        </button>
      </div>
      ...
      {activeTab === "overview" && (
        <>
          ...
          >
            ...
            <div style={{ marginTop: 18, padding: "14px 18px", background: "rgba(15, 23, 42, 0.8)", border: "1px solid rgba(56, 189, 248, 0.25)", borderRadius: 10, fontSize: "0.85rem", color: "#cbd5e1" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "12px", marginTop: 8 }}>
                ...
                <div>
                  <strong style={{ color: "#38bdf8" }}>2. Theta Decay Mechanics:</strong> The -$199 open mark represents initial bid-ask friction. As time passes into expiration, out-of-the-money options decay to $0, returning the +$537 to equity.
                </div>
                <div>
                  <strong style={{ color: "#f59e0b" }}>3. Deterministic Risk Control:</strong> Max loss is capped at $500 per spread with zero naked options. 99.3% of capital is strictly preserved across market volatility.
                </div>
              </div>
            </div>
          ...
          <div className="actions" style={{ margin: "16px 0 8px" }}>
      ...
      {/* TAB 2: STRUCTURES BOOK */}
      {activeTab === "structures" && <StructuresBook />}

      {/* TAB 3: VOLATILITY REGIME */}
      {activeTab === "regime" && <VolatilityRegimeMatrix />}

      {/* TAB 4: RISK GATE PROBE */}
      {activeTab === "probe" && <RiskGateProbe />}

      {/* TAB 5: DECISION STREAM & REFUSAL LEDGER */}
      {activeTab === "stream" && <DecisionStream />}
    </div>
  );
}
